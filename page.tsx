...
import { Shield, BookOpen, Layers, Cpu, DollarSign, CheckCircle2 } from 'lucide-react';
      ...
      <div className="flex-1 p-16 overflow-y-auto bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-surface/40 to-black">
        ...
        {activeSection === 'summary' && (
          <div className="max-w-4xl animate-in fade-in duration-500">
            ...
            <p className="text-muted text-sm mb-8 font-light">The core thesis and macroeconomic intent. Type and modify your strategy live; changes persist automatically in browser storage.</p>
